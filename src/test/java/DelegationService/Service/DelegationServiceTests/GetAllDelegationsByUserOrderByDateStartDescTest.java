...
public class GetAllDelegationsByUserOrderByDateStartDescTest {
    ...
    @Test
    public void getAllDelegationsByUserOrderByDateStartDesc() {
        List<Delegation> orderedDelegations = testDelegationService.getAllDelegationsByUserOrderByDateStartDesc(1);

        Assert.assertEquals(createdDelegations, orderedDelegations);
    }
}